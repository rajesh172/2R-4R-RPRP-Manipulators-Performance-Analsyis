function Out= ode_solver_without_constraint(t,x)
...
H2 =  2*m4*sin(x(1) - x(5))*x(8)*x(6) - l1*m3*x(2)^2 - l1*m4*x(2)^2 - m2*x(3)*x(2)^2 - m3*x(3)*x(2)^2 - m4*x(3)*x(2)^2 - l2*m3*x(6)^2*cos(x(1) - x(5)) - l2*m4*x(6)^2*cos(x(1) - x(5)) - l1*m2*x(2)^2 - m4*x(7)*x(6)^2*cos(x(1) - x(5)) + g*sin(x(1))*(m2+m3+m4);
...
H4 = - l2*m4*x(6)^2 - m4*x(7)*x(6)^2 - l1*m4*x(2)^2*cos(x(1) - x(5)) - 2*m4*sin(x(1) - x(5))*x(4)*x(2) - m4*x(3)*x(2)^2*cos(x(1) - x(5)) + m4*g*sin(x(5));
