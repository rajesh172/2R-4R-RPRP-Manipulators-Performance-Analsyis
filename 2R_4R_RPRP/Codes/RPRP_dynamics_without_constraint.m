...
%% ODE solver
 T=0:1/100000:10;
[t,x]=ode23('ode_solver_without_constraint',T,[0,0.5,0,0.8,0,1,0,2]); 
...
PE(i,1) = g*l1*sin(th1(i))*(m1+m2+m3+m4) +g*r1(i)*sin(th1(i))*(m2+m3+m4) + g*l2*sin(th2(i))*(m3+m4) + g*r2(i)*sin(th2(i))*(m4) ; % Assuming P.E to be zero
end
