...
for k=1:1:length(x)-1
    ...
    dynamic_manipulability(1,k) = Dynamic_manipul(th1,th1+th2,th1+th2+th3,th1+th2+th3+th4,J);
...
l1=1;l2=1;l3=1;l4=1;
J=[-l1*sin(th1)-l2*sin(th2+th1)-l3*sin(th3+th2+th1)-l4*sin(th4+th3+th2+th1),-l2*sin(th2+th1)-l3*sin(th3+th2+th1)-l4*sin(th4+th3+th2+th1),-l3*sin(th1+th2+th3)-l4*sin(th4+th3+th2+th1),-l4*sin(th4+th3+th2+th1);l1*cos(th1)+l2*cos(th2+th1)+l3*cos(th3+th2+th1)+l4*cos(th4+th3+th2+th1),l2*cos(th2+th1)+l3*cos(th3+th2+th1)+l4*cos(th4+th3+th2+th1),l3*cos(th1+th2+th3)+l4*cos(th4+th3+th2+th1),l4*cos(th4+th3+th2+th1)];
end

%%
function [x,y] = fwd_kin_4(q)
l1=1;l2=1;l3=1;l4=1;
x=l1*cos(q(1,:)) + l2*cos(q(1,:)+q(2,:)) + l3*cos(q(1,:)+q(2,:)+q(3,:)) + l4*cos(q(1,:)+q(2,:)+q(3,:)+q(4,:));
y=l1*sin(q(1,:)) + l2*sin(q(1,:)+q(2,:)) + l3*sin(q(1,:)+q(2,:)+q(3,:)) + l4*sin(q(1,:)+q(2,:)+q(3,:)+q(4,:));
end
...
M12 = l1*l2*m2*cos(th1 - th2) + l1*l2*m3*cos(th1 - th2) + l1*l2*m4*cos(th1 - th2);
M13 = l1*l3*m3*cos(th1 - th3) + l1*l3*m4*cos(th1 - th3);
M14 = l1*l4*m4*cos(th1 - th4);

M21 = (m2*(2*l1*l2*cos(th1)*cos(th2) + 2*l1*l2*sin(th1)*sin(th2)))/2 + (m3*(2*l1*l2*cos(th1)*cos(th2) + 2*l1*l2*sin(th1)*sin(th2)))/2 + (m4*(2*l1*l2*cos(th1)*cos(th2) + 2*l1*l2*sin(th1)*sin(th2)))/2;
M22 = (m2*(2*l2^2*cos(th2)^2 + 2*l2^2*sin(th2)^2))/2 + (m3*(2*l2^2*cos(th2)^2 + 2*l2^2*sin(th2)^2))/2 + (m4*(2*l2^2*cos(th2)^2 + 2*l2^2*sin(th2)^2))/2;
M23 = (m3*(2*l2*l3*cos(th2)*cos(th3) + 2*l2*l3*sin(th2)*sin(th3)))/2 + (m4*(2*l2*l3*cos(th2)*cos(th3) + 2*l2*l3*sin(th2)*sin(th3)))/2;
M24 = (m4*(2*l2*l4*cos(th2)*cos(th4) + 2*l2*l4*sin(th2)*sin(th4)))/2;

M31 = (m3*(2*l1*l3*cos(th1)*cos(th3) + 2*l1*l3*sin(th1)*sin(th3)))/2 + (m4*(2*l1*l3*cos(th1)*cos(th3) + 2*l1*l3*sin(th1)*sin(th3)))/2;
M32 = (m3*(2*l2*l3*cos(th2)*cos(th3) + 2*l2*l3*sin(th2)*sin(th3)))/2 + (m4*(2*l2*l3*cos(th2)*cos(th3) + 2*l2*l3*sin(th2)*sin(th3)))/2;
M33 = (m3*(2*l3^2*cos(th3)^2 + 2*l3^2*sin(th3)^2))/2 + (m4*(2*l3^2*cos(th3)^2 + 2*l3^2*sin(th3)^2))/2;
M34 = (m4*(2*l3*l4*cos(th3)*cos(th4) + 2*l3*l4*sin(th3)*sin(th4)))/2;

M41 = (m4*(2*l1*l4*cos(th1)*cos(th4) + 2*l1*l4*sin(th1)*sin(th4)))/2;
M42 = (m4*(2*l2*l4*cos(th2)*cos(th4) + 2*l2*l4*sin(th2)*sin(th4)))/2;
M43 = (m4*(2*l3*l4*cos(th3)*cos(th4) + 2*l3*l4*sin(th3)*sin(th4)))/2;
M44 = (m4*(2*l4^2*cos(th4)^2 + 2*l4^2*sin(th4)^2))/2;
...
for i=1:30:length(xi)
    ...
    H23 = [cos(theta3) -sin(theta3) 0 l3*cos(theta3);sin(theta3) cos(theta3) 0 l3*sin(theta3);0 0 1 0;0 0 0 1]; %Frame 2 to 3 tranformation
    H34 = [cos(theta4) -sin(theta4) 0 l4*cos(theta4);sin(theta4) cos(theta4) 0 l4*sin(theta4);0 0 1 0;0 0 0 1]; %Frame 3 to 4 tranformation
